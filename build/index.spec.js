...
describe("Neo4j Typescript REST", function () {
    ...
    let badNeo4jConfig = JSON.parse(JSON.stringify(neo4jConfig));
    let requestOptions = neo4j.getRequestOptions();
    ...
    describe("#global graph functions", function () {
        it("should fail to return all graph relationship types due to request error.", function (done) {
            let goodBaseUrl = requestOptions.baseUrl;
    ...
    describe("#Relationship level functions", function () {
        let sampleStartNode = null;
        let sampleEndNode = null;
        let sampleNewRelationship = null;
        before(function (done) {
            neo4j.createNode()
                .then((response) => {
